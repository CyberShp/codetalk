...
const includeSyntheticSlowAgent = process.env.CODETALK_E2E_ENABLE_SYNTHETIC_SLOW_AGENT === "1";
const slowAgentScript = path.join(isolatedDataDir, "playwright-slow-agent.py");
if (includeSyntheticSlowAgent) {
  fs.writeFileSync(
    slowAgentScript,
    [
      "import json",
