...
export function TaskCenterPage() {
  ...
  return <main className="ct-v2-library ct-v2-task-center">
    ...
    <section className="ct-v2-task-filters" aria-label="任务筛选">
      ...
      <label><span>质量</span><select value={query.quality_status} onChange={(event) => setFilter("quality_status", event.target.value)}><option value="">全部</option><option value="not_checked">未检查</option><option value="pending">检查中</option><option value="passed">通过</option><option value="warning">有警告</option><option value="blocked">已阻断</option></select></label>
