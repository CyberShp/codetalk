...
| Zero Public Egress | network policy, model factory and Agent sandbox | Runtime has immutable host/CIDR policy, vendor hard-deny and scrubbed Agent environment; deployment traffic capture and certified firewall evidence remain | policy client, sandbox audit and traffic-capture tests |
