...
def test_source_analysis_cache_schema_tracks_relevance_v9(monkeypatch):
    monkeypatch.delenv("SOURCE_ANALYSIS_SCHEMA_VERSION", raising=False)

    assert Settings(_env_file=None).source_analysis_schema_version == "source-evidence-pack-v9"
