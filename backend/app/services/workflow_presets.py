...
_BASIC_ISCSI_EVIDENCE_HINTS = [
    {"path": "lib/iscsi/iscsi.c", "term": "iscsi_auth_params", "label": "CHAP negotiation", "contract_required": True},
    ...
    {"path": "lib/iscsi/iscsi.c", "term": "iscsi_conn_login_pdu_err_complete", "label": "login error completion", "contract_required": True},
    {"path": "lib/iscsi/iscsi.c", "term": "iscsi_op_login_rsp_handle_csg_bit", "label": "login stage transition"},
    {"path": "lib/iscsi/iscsi.c", "term": "iscsi_pdu_payload_op_login", "label": "login payload entry", "contract_required": True},
    ...
    {"path": "lib/iscsi/iscsi.h", "term": "ISCSI_LOGIN_TIMEOUT", "label": "login timeout constant", "contract_required": True},
    {"path": "include/spdk/iscsi_spec.h", "term": "ISCSI_LOGIN_AUTHENT_FAIL", "label": "wire authentication failure code", "contract_required": True},
    ...
    {"path": "test/iscsi_tgt/chap/chap_mutual_not_set.sh", "term": "configuring initiator with biderectional authentication", "label": "mutual CHAP negative test", "contract_required": True},
    ...
    {"path": "test/iscsi_tgt/multiconnection/multiconnection.sh", "term": "CONNECTION_NUMBER", "label": "multi-connection test", "contract_required": True},
